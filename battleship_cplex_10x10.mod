 ...
 *********************************************/
 ...
 using CP;
 int c = 11; // kolumn jest zawsze o 2 wiecej niz w planszy do gry
 int r = 11; //rzedów jest zawsze o 2 wiecej niz w planszy do gry
 range crange = 1..c;
 range rrange = 1..r;
 ...
 int rlimit[rrange] = [0,5,2,2,2,4,2,4,1,5,0]; //ograniczenia rzedów
 int climit[crange] = [0,5,3,4,0,5,1,3,3,3,0]; //ograniczenia kolumn
