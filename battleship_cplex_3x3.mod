 ...
 *********************************************/
 ...
 using CP;
 int c = 5; // kolumn jest zawsze o 2 wiecej niz w planszy do gry
 int r = 5; //rzedów jest zawsze o 2 wiecej niz w planszy do gry
 range crange = 1..c;
 range rrange = 1..r;
 ...
 int rlimit[rrange] = [0,2,1,2,0]; //ograniczenia rzedów
 int climit[crange] = [0,2,0,3,0]; //ograniczenia kolumn
